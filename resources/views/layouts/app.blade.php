...
<body
    class="font-sans antialiased bg-zinc-50 dark:bg-[#09090b] text-zinc-900 dark:text-zinc-100 flex h-screen overflow-hidden transition-colors duration-300"
    ...
    <div class="flex-1 flex flex-col h-screen relative overflow-hidden">
        <!-- Top Header -->
        <header
            class="glass-sidebar h-16 flex items-center justify-between px-8 z-10 border-b border-zinc-200 dark:border-white/5 shadow-sm">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative hidden md:block">
                    <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-zinc-500" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                    <input type="text" placeholder="Search anything..."
                        class="bg-white dark:bg-zinc-900/50 border border-zinc-300 dark:border-white/5 rounded-full pl-10 pr-4 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 w-64 transition-all text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 shadow-sm dark:shadow-none">
                </div>
                        ...
                        <div class="py-1">
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <button type="submit" @click.prevent="$root.submit();"
                                    class="block w-full text-left px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-red-600 dark:hover:text-red-400 transition-colors flex items-center gap-2">
                                    <svg class="w-4 h-4 text-zinc-400 group-hover:text-red-500" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

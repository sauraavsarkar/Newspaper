...
class MorningDashboard extends Component
{
    public function render(\App\Services\TrendingService $trendingService)
    {
        $user = Auth::user();
        ...
        if ($morningDigest->isEmpty()) {
            $morningDigest = $trendingService->getTrendingArticles(12, 6);
        }
        ...
        // Trending Right Now
        $trending = $trendingService->getTrendingArticles(24, 5);
        ...
        return view('livewire.reader.morning-dashboard', [
            'greeting' => $greeting,
